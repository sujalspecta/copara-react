...
const expertsData: ExpertType[] = [
  { image: user1, name: 'Alex Carry', alt: 'avatar' },
  { image: user2, name: 'Amanda Lewis', alt: 'avatar-1' },
  { image: user3, name: 'David Hassan', alt: 'avatar-1' },
  { image: user4, name: 'Elena Novak', alt: 'avatar-1' },
]

const ExpertCTA = () => {
  return (
    <section className="pb-20 md:pb-25 lg:pb-27.5">
          ...
          <div>
            <div className="relative overflow-hidden rounded-xl">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <Link
                  to="/contact"
                  className="group text-primary inline-flex items-center justify-center rounded-lg bg-white px-10 py-5 font-medium transition-all"
                >
